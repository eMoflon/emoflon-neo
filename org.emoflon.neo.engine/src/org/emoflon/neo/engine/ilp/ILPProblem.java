...
public class ILPProblem {
	 ...
	 */
	protected Map<Integer, Integer> getInternalFixedVariableValues() {
	 ...
	 */
	protected Set<Integer> getLazyFixedVariables() {
	...
	public final class ILPLinearExpression {
		 ...
		 */
		private final Map<Integer, Double> terms = new HashMap<>();
	...
	public final class ILPSolution {
		 ...
		 */
		private final Map<Integer, Integer> variableAllocations;
		/**
