...
import org.emoflon.neo.api.exttype2doc_lookahead.tgg.*;
...
public class ExtType2Doc_LookAhead_GEN_Run {
	public static final String SRC_MODEL_NAME = "ExtType2Doc_LookAhead_Source";
	public static final String TRG_MODEL_NAME = "ExtType2Doc_LookAhead_Target";

	private static final Logger logger = Logger.getLogger(ExtType2Doc_LookAhead_GEN_Run.class);

	public static void main(String[] pArgs) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new ExtType2Doc_LookAhead_GEN_Run();
		app.runGenerator();
	}
	...
	protected NeoGenerator createGenerator(NeoCoreBuilder builder) {
		var allRules = new API_ExtType2Doc_LookAhead_GEN(builder).getAllRulesForExtType2Doc_LookAhead_GEN();
