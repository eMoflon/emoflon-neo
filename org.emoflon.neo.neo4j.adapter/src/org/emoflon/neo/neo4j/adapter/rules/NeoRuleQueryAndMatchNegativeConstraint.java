...
public class NeoRuleQueryAndMatchNegativeConstraint extends NeoRule {

	public NeoRuleQueryAndMatchNegativeConstraint(Rule r, NeoPattern contextPattern, IBuilder builder, NeoMask mask,
