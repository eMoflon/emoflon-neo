...
public class NeoRuleQueryAndMatchConstraintRef extends NeoRule {

	public NeoRuleQueryAndMatchConstraintRef(Rule r, NeoPattern contextPattern, IBuilder builder, NeoMask mask,
