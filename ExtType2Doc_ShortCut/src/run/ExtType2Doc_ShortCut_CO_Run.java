...
import org.emoflon.neo.api.exttype2doc_shortcut.tgg.API_ExtType2Doc_ShortCut_CO;
...
public class ExtType2Doc_ShortCut_CO_Run {
	private static final Logger logger = Logger.getLogger(ExtType2Doc_ShortCut_CO_Run.class);
	...
	public static void main(String[] pArgs) throws Exception {
		...
		var app = new ExtType2Doc_ShortCut_CO_Run();
		app.run();
	}
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		var api = new API_ExtType2Doc_ShortCut(builder);
		var genAPI = new API_ExtType2Doc_ShortCut_GEN(builder);
		var coAPI = new API_ExtType2Doc_ShortCut_CO(builder);
		checkOnly = new CheckOnlyOperationalStrategy(//
				solver, //
				genAPI.getAllRulesForExtType2Doc_ShortCut_GEN(), //
				coAPI.getAllRulesForExtType2Doc_ShortCut_CO(), //
				api.getConstraintsOfExtType2Doc_ShortCut(), //
				builder, //
				srcModel, //
				trgModel//
		);
