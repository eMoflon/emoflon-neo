...
public class ClassToRelational_FWD_OPT_Run_App extends ClassToRelational_FWD_OPT_Run {
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		...
		var maxRuleApps = new MaximalRuleApplicationsTerminationCondition(choiceOfFwdRules, 5);
		...
		return new NeoGenerator(//
				...
				new NoMoreMatchesTerminationCondition() {
					...
					public boolean isReached(MatchContainer<NeoMatch, NeoCoMatch> matchContainer) {
						return super.isReached(matchContainer) || maxRuleApps.isReached(matchContainer);
					}
				}, //
