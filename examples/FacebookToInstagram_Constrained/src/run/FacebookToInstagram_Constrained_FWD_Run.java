...
import org.emoflon.neo.api.facebooktoinstagram_constrained.tgg.API_FacebookToInstagram_Constrained_FWD;
...
public class FacebookToInstagram_Constrained_FWD_Run {
	private static final Logger logger = Logger.getLogger(FacebookToInstagram_Constrained_FWD_Run.class);
	private String srcModelName;
	private String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new FacebookToInstagram_Constrained_FWD_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public FacebookToInstagram_Constrained_FWD_Run(String srcModelName, String trgModelName) {
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		return new NeoGenerator(//
				new API_FacebookToInstagram_Constrained_FWD(builder).getAllRulesForFacebookToInstagram_Constrained_FWD(), //
