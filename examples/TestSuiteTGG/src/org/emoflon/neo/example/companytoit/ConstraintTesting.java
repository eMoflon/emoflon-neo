...
public class ConstraintTesting extends ENeoTest{
	...
	public void testConsistentTriple1_CO() throws Exception {
		...
		testForConsistency(new CompanyToIT_Constrained_CO_Run("ConsistentSource1", "ConsistentTarget1").runCheckOnly(), 26);
	}
	...
	public void testConsistentTriple1_CC() throws Exception {
		exportTriple(api.getModel_ConsistentSource1(), //
				api.getModel_ConsistentTarget1());
		testForConsistency(new CompanyToIT_Constrained_CC_Run("ConsistentSource1", "ConsistentTarget1").runCorrCreation(),
				26);
	}
	...
	public void testInconsistentTriple1_CO() throws Exception {
		...
		testForInconsistency(new CompanyToIT_Constrained_CO_Run("InconsistentSource1", "InconsistentTarget1").runCheckOnly(),
				5, 15);
	}
	...
	public void testInconsistentTriple1_CC() throws Exception {
		exportTriple(api.getModel_InconsistentSource1(), //
				api.getModel_InconsistentTarget1());
		testForInconsistency(new CompanyToIT_Constrained_CC_Run("InconsistentSource1", "InconsistentTarget1").runCorrCreation(),
				5, 13);
	}
	...
	public void testInconsistentTriple2_CO() throws Exception {
		...
		testForInconsistency(new CompanyToIT_Constrained_CO_Run("InconsistentSource2", "InconsistentTarget2").runCheckOnly(),
				5, 19);
	}
	...
	public void testInconsistentTriple2_CC() throws Exception {
		exportTriple(api.getModel_InconsistentSource2(), //
				api.getModel_InconsistentTarget2());
		testForInconsistency(new CompanyToIT_Constrained_CC_Run("InconsistentSource2", "InconsistentTarget2").runCorrCreation(),
				5, 17);
	}
	...
	public void testInconsistentTriple3_CO() throws Exception {
		...
		testForInconsistency(new CompanyToIT_Constrained_CO_Run("InconsistentSource3", "InconsistentTarget3").runCheckOnly(),
				5, 19);
	}
	...
	public void testInconsistentTriple3_CC() throws Exception {
		exportTriple(api.getModel_InconsistentSource3(), //
				api.getModel_InconsistentTarget3());
		testForInconsistency(new CompanyToIT_Constrained_CC_Run("InconsistentSource3", "InconsistentTarget3").runCorrCreation(),
				5, 17);
	}
	...
	//co for inconsistent triple4
		...
		public void testInconsistentTriple4_CO() throws Exception {
			...
			testForInconsistency(new CompanyToIT_Constrained_CO_Run("InconsistentSource4", "InconsistentTarget4").runCheckOnly(),
					5, 24);
		}
		...
		public void testInconsistentTriple4_CC() throws Exception {
			exportTriple(api.getModel_InconsistentSource4(), //
					api.getModel_InconsistentTarget4());
			testForInconsistency(new CompanyToIT_Constrained_CC_Run("InconsistentSource4", "InconsistentTarget4").runCorrCreation(),
					5, 21);
		}
}
