 ...
 */
package org.emoflon.neo.api.companytoit.models;
...
public class API_FG_ES {
	...
	public API_FG_ES(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot, String neocoreURI){
		this((EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/CompanyToIT/src/models/FG_ES.msl", platformResourceURIRoot, platformPluginURIRoot, neocoreURI), builder);
	}
	...
	//:~> platform:/resource/CompanyToIT/src/models/FG_ES.msl#//@entities.0
	public Model getModel_ES(){
		return (Model) spec.getEntities().get(0);
	}
	
	//:~> platform:/resource/CompanyToIT/src/models/FG_ES.msl#//@entities.1
