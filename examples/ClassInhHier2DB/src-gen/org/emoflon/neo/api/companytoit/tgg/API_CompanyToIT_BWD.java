...
public class API_CompanyToIT_BWD {
	...
	public API_CompanyToIT_BWD(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot, String neocoreURI){
		this((EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_BWD.msl", platformResourceURIRoot, platformPluginURIRoot, neocoreURI), builder);
	}
	...
	//:~> platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_BWD.msl#//@entities.0
	...
	//:~> platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_BWD.msl#//@entities.1
	...
	//:~> platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_BWD.msl#//@entities.2
	...
	//:~> platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_BWD.msl#//@entities.3
	...
	//:~> platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_BWD.msl#//@entities.4
	...
	//:~> platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_BWD.msl#//@entities.5
	public IConstraint getConstraint_AdminToRouterRuleNAC() {
		var c = (Constraint) spec.getEntities().get(5);
		return NeoConstraintFactory.createNeoConstraint(c, builder);
	}
	
	//:~> platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_BWD.msl#//@entities.6
	...
	//:~> platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_BWD.msl#//@entities.7
	...
	//:~> platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_BWD.msl#//@entities.8
