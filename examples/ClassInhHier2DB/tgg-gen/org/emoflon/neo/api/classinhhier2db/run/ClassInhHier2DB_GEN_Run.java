...
public class ClassInhHier2DB_GEN_Run {
	...
	protected static final Logger logger = Logger.getLogger(ClassInhHier2DB_GEN_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new ClassInhHier2DB_GEN_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public ClassInhHier2DB_GEN_Run(String srcModelName, String trgModelName) {
