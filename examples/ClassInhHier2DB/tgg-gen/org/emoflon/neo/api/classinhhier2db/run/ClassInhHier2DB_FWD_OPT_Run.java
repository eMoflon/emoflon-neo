...
public class ClassInhHier2DB_FWD_OPT_Run {
	...
	public static void main(String[] args) throws Exception {
		...
		var app = new ClassInhHier2DB_FWD_OPT_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public ClassInhHier2DB_FWD_OPT_Run(String srcModelName, String trgModelName) {
		this.srcModelName = srcModelName;
		this.trgModelName = trgModelName;
	}
	
	public ClassInhHier2DB_FWD_OPT_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		ClassInhHier2DB_FWD_OPT_Run.solver = solver;
	}
