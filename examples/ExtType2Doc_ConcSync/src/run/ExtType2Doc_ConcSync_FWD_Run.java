...
import org.emoflon.neo.api.exttype2doc_concsync.tgg.API_ExtType2Doc_ConcSync_FWD;
...
public class ExtType2Doc_ConcSync_FWD_Run {
	private static final Logger logger = Logger.getLogger(ExtType2Doc_ConcSync_FWD_Run.class);

	public static void main(String[] pArgs) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new ExtType2Doc_ConcSync_FWD_Run();
		app.runGenerator();
	}
	...
	public void runGenerator() throws FlattenerException, Exception {
		try (var builder = API_Common.createBuilder()) {
			...
			var generator = new NeoGenerator(//
					new API_ExtType2Doc_ConcSync_FWD(builder).getAllRulesForExtType2Doc_ConcSync_FWD(), //
