...
import org.emoflon.neo.api.exttype2doc_concsync.tgg.*;
...
public class ExtType2Doc_ConcSync_GEN_Run {
	public static final String SRC_MODEL_NAME = "ExtType2Doc_ConcSync_Source";
	public static final String TRG_MODEL_NAME = "ExtType2Doc_ConcSync_Target";

	private static final Logger logger = Logger.getLogger(ExtType2Doc_ConcSync_GEN_Run.class);

	public static void main(String[] pArgs) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new ExtType2Doc_ConcSync_GEN_Run();
		app.runGenerator();
	}

	public void runGenerator() throws FlattenerException, Exception {
		try (var builder = API_Common.createBuilder()) {
			new API_ExtType2Doc_ConcSync(builder).exportMetamodelsForExtType2Doc_ConcSync();
	...
	protected NeoGenerator createGenerator(NeoCoreBuilder builder) {
		var allRules = new API_ExtType2Doc_ConcSync_GEN(builder).getAllRulesForExtType2Doc_ConcSync_GEN();
