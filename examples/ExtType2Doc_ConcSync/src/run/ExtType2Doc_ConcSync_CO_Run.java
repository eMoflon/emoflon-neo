...
import org.emoflon.neo.api.exttype2doc_concsync.tgg.API_ExtType2Doc_ConcSync_CO;
...
public class ExtType2Doc_ConcSync_CO_Run {
	private static final Logger logger = Logger.getLogger(ExtType2Doc_ConcSync_CO_Run.class);
	...
	public static void main(String[] pArgs) throws Exception {
		...
		var app = new ExtType2Doc_ConcSync_CO_Run();
		app.run();
	}
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		...
		var coAPI = new API_ExtType2Doc_ConcSync_CO(builder);
		checkOnly = new CheckOnlyOperationalStrategy(//
				solver, //
				genAPI.getAllRulesForExtType2Doc_ConcSync_GEN(), //
				coAPI.getAllRulesForExtType2Doc_ConcSync_CO(), //
