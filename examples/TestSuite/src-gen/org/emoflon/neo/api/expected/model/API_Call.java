...
public class API_Call {
	...
	public API_Call(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot){
		spec = (EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/TestSuite/resources/expected/model/Call.msl", platformResourceURIRoot, platformPluginURIRoot);
		this.builder = builder;
	}

	//:~> platform:/resource/TestSuite/resources/expected/model/Call.msl#//@entities.0
	...
	//:~> platform:/resource/TestSuite/resources/expected/model/Call.msl#//@entities.1
