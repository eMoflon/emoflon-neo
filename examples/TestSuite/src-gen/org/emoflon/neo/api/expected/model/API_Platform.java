...
public class API_Platform {
	...
	public API_Platform(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot){
		spec = (EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/TestSuite/resources/expected/model/Platform.msl", platformResourceURIRoot, platformPluginURIRoot);
		this.builder = builder;
	}

	//:~> platform:/resource/TestSuite/resources/expected/model/Platform.msl#//@entities.0
	...
	//:~> platform:/resource/TestSuite/resources/expected/model/Platform.msl#//@entities.1
