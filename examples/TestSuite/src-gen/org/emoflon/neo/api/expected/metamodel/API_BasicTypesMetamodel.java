...
public class API_BasicTypesMetamodel {
	...
	public API_BasicTypesMetamodel(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot){
		spec = (EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/TestSuite/resources/expected/metamodel/BasicTypesMetamodel.msl", platformResourceURIRoot, platformPluginURIRoot);
		this.builder = builder;
	}

	//:~> platform:/resource/TestSuite/resources/expected/metamodel/BasicTypesMetamodel.msl#//@entities.0
