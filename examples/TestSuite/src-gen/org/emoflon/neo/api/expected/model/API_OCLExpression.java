...
public class API_OCLExpression {
	...
	public API_OCLExpression(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot){
		spec = (EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/TestSuite/resources/expected/model/OCLExpression.msl", platformResourceURIRoot, platformPluginURIRoot);
		this.builder = builder;
	}

	//:~> platform:/resource/TestSuite/resources/expected/model/OCLExpression.msl#//@entities.0
	public Metamodel getMetamodel_OCLGrammar(){
		return (Metamodel) spec.getEntities().get(0);
	}
	
	//:~> platform:/resource/TestSuite/resources/expected/model/OCLExpression.msl#//@entities.1
