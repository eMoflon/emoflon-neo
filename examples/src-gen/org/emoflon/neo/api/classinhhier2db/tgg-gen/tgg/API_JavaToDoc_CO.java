...
public class API_JavaToDoc_CO {
	...
	public API_JavaToDoc_CO(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot, String neocoreURI){
		this((EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/ClassInhHier2DB/JavaToDoc/tgg-gen/tgg/JavaToDoc_CO.msl", platformResourceURIRoot, platformPluginURIRoot, neocoreURI), builder);
	}

	public API_JavaToDoc_CO(EMSL_Spec spec, NeoCoreBuilder builder) {
		this.spec = spec;
		this.builder = builder;
	}

	//:~> platform:/resource/ClassInhHier2DB/JavaToDoc/tgg-gen/tgg/JavaToDoc_CO.msl#//@entities.0
	...
	//:~> platform:/resource/ClassInhHier2DB/JavaToDoc/tgg-gen/tgg/JavaToDoc_CO.msl#//@entities.1
	...
	//:~> platform:/resource/ClassInhHier2DB/JavaToDoc/tgg-gen/tgg/JavaToDoc_CO.msl#//@entities.2
	...
	//:~> platform:/resource/ClassInhHier2DB/JavaToDoc/tgg-gen/tgg/JavaToDoc_CO.msl#//@entities.3
