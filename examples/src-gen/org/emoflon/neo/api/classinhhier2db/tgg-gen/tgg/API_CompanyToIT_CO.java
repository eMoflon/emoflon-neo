...
public class API_CompanyToIT_CO {
	private EMSL_Spec spec;
	private NeoCoreBuilder builder;

	/** Use this constructor for default values */
	public API_CompanyToIT_CO(NeoCoreBuilder builder) {
		this(builder, API_Common.PLATFORM_RESOURCE_URI, API_Common.PLATFORM_PLUGIN_URI, API_Common.NEOCORE_URI_INSTALLED);
	}

	/** Use this constructor to configure values for loading EMSL files */
	public API_CompanyToIT_CO(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot, String neocoreURI){
		this((EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/ClassInhHier2DB/CompanyToIT/tgg-gen/tgg/CompanyToIT_CO.msl", platformResourceURIRoot, platformPluginURIRoot, neocoreURI), builder);
	}

	public API_CompanyToIT_CO(EMSL_Spec spec, NeoCoreBuilder builder) {
		this.spec = spec;
		this.builder = builder;
	}

	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT/tgg-gen/tgg/CompanyToIT_CO.msl#//@entities.0
	public Collection<NeoRule> getAllRulesForCompanyToIT_CO() {
	...
	public Collection<NeoConstraint> getAllConstraintsForCompanyToIT_CO() {
		Collection<NeoConstraint> constraints = new HashSet<>();
		return constraints;
	}
	
	public Collection<Rule> getAllEMSLRulesForCompanyToIT_CO(){
	...
	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT/tgg-gen/tgg/CompanyToIT_CO.msl#//@entities.1
	...
	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT/tgg-gen/tgg/CompanyToIT_CO.msl#//@entities.2
	...
	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT/tgg-gen/tgg/CompanyToIT_CO.msl#//@entities.3
	...
	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT/tgg-gen/tgg/CompanyToIT_CO.msl#//@entities.4
