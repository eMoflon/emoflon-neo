...
public class API_JavaToDoc_CC {
	...
	public API_JavaToDoc_CC(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot, String neocoreURI){
		this((EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/ClassInhHier2DB/JavaToDoc/tgg-gen/tgg/JavaToDoc_CC.msl", platformResourceURIRoot, platformPluginURIRoot, neocoreURI), builder);
	}

	public API_JavaToDoc_CC(EMSL_Spec spec, NeoCoreBuilder builder) {
		this.spec = spec;
		this.builder = builder;
	}

	//:~> platform:/resource/ClassInhHier2DB/JavaToDoc/tgg-gen/tgg/JavaToDoc_CC.msl#//@entities.0
	...
	//:~> platform:/resource/ClassInhHier2DB/JavaToDoc/tgg-gen/tgg/JavaToDoc_CC.msl#//@entities.1
	...
	//:~> platform:/resource/ClassInhHier2DB/JavaToDoc/tgg-gen/tgg/JavaToDoc_CC.msl#//@entities.2
	...
	//:~> platform:/resource/ClassInhHier2DB/JavaToDoc/tgg-gen/tgg/JavaToDoc_CC.msl#//@entities.3
