...
public class API_Facebook {
	...
	public API_Facebook(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot, String neocoreURI){
		this((EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Facebook.msl", platformResourceURIRoot, platformPluginURIRoot, neocoreURI), builder);
	}
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Facebook.msl#//@entities.0
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Facebook.msl#//@entities.1
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Facebook.msl#//@entities.2
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Facebook.msl#//@entities.3
	public IConstraint getConstraint_NoDoubleFriendship() {
		var c = (Constraint) spec.getEntities().get(3);
		return NeoConstraintFactory.createNeoConstraint(c, builder);
	}
	
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Facebook.msl#//@entities.4
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Facebook.msl#//@entities.5
	public IConstraint getConstraint_NoInterFriendship() {
		var c = (Constraint) spec.getEntities().get(5);
		return NeoConstraintFactory.createNeoConstraint(c, builder);
	}
	
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Facebook.msl#//@entities.6
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Facebook.msl#//@entities.7
	public IConstraint getConstraint_NoDoubleParents() {
		var c = (Constraint) spec.getEntities().get(7);
		return NeoConstraintFactory.createNeoConstraint(c, builder);
	}
	
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Facebook.msl#//@entities.8
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Facebook.msl#//@entities.9
	public IConstraint getConstraint_NoDoubleSibling() {
		var c = (Constraint) spec.getEntities().get(9);
		return NeoConstraintFactory.createNeoConstraint(c, builder);
	}
	
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Facebook.msl#//@entities.10
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Facebook.msl#//@entities.11
	public IConstraint getConstraint_NoDoubleSpouses() {
		var c = (Constraint) spec.getEntities().get(11);
		return NeoConstraintFactory.createNeoConstraint(c, builder);
	}
	
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Facebook.msl#//@entities.12
