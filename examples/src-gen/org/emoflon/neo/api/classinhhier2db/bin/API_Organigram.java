...
public class API_Organigram {
	...
	public API_Organigram(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot, String neocoreURI){
		this((EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/ClassInhHier2DB/Organigram/bin/Organigram.msl", platformResourceURIRoot, platformPluginURIRoot, neocoreURI), builder);
	}
	...
	//:~> platform:/resource/ClassInhHier2DB/Organigram/bin/Organigram.msl#//@entities.0
	...
	//:~> platform:/resource/ClassInhHier2DB/Organigram/bin/Organigram.msl#//@entities.1
	public Model getModel_TestEmployee(){
		return (Model) spec.getEntities().get(1);
	}
	
	//:~> platform:/resource/ClassInhHier2DB/Organigram/bin/Organigram.msl#//@entities.2
	public Model getModel_SimpleCompany(){
		return (Model) spec.getEntities().get(2);
	}
	
	//:~> platform:/resource/ClassInhHier2DB/Organigram/bin/Organigram.msl#//@entities.3
	...
	//:~> platform:/resource/ClassInhHier2DB/Organigram/bin/Organigram.msl#//@entities.4
	...
	//:~> platform:/resource/ClassInhHier2DB/Organigram/bin/Organigram.msl#//@entities.5
	...
	//:~> platform:/resource/ClassInhHier2DB/Organigram/bin/Organigram.msl#//@entities.6
