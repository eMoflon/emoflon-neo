...
public class API_FacebookToInstagram_Constrained_FWD {
	private EMSL_Spec spec;
	private NeoCoreBuilder builder;

	/** Use this constructor for default values */
	public API_FacebookToInstagram_Constrained_FWD(NeoCoreBuilder builder) {
		this(builder, API_Common.PLATFORM_RESOURCE_URI, API_Common.PLATFORM_PLUGIN_URI, API_Common.NEOCORE_URI_INSTALLED);
	}

	/** Use this constructor to configure values for loading EMSL files */
	public API_FacebookToInstagram_Constrained_FWD(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot, String neocoreURI){
		this((EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/ClassInhHier2DB/FacebookToInstagram_Constrained/bin/tgg/FacebookToInstagram_Constrained_FWD.msl", platformResourceURIRoot, platformPluginURIRoot, neocoreURI), builder);
	}

	public API_FacebookToInstagram_Constrained_FWD(EMSL_Spec spec, NeoCoreBuilder builder) {
		this.spec = spec;
		this.builder = builder;
	}

	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagram_Constrained/bin/tgg/FacebookToInstagram_Constrained_FWD.msl#//@entities.0
	public Collection<NeoRule> getAllRulesForFacebookToInstagram_Constrained_FWD() {
	...
	public Collection<NeoConstraint> getAllConstraintsForFacebookToInstagram_Constrained_FWD() {
		Collection<NeoConstraint> constraints = new HashSet<>();
		return constraints;
	}
	
	public Collection<Rule> getAllEMSLRulesForFacebookToInstagram_Constrained_FWD(){
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagram_Constrained/bin/tgg/FacebookToInstagram_Constrained_FWD.msl#//@entities.1
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagram_Constrained/bin/tgg/FacebookToInstagram_Constrained_FWD.msl#//@entities.2
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagram_Constrained/bin/tgg/FacebookToInstagram_Constrained_FWD.msl#//@entities.3
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagram_Constrained/bin/tgg/FacebookToInstagram_Constrained_FWD.msl#//@entities.4
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagram_Constrained/bin/tgg/FacebookToInstagram_Constrained_FWD.msl#//@entities.5
	public IConstraint getConstraint_RequestFriendship_NoDoubleFollowsNAC() {
		var c = (Constraint) spec.getEntities().get(5);
		return NeoConstraintFactory.createNeoConstraint(c, builder);
	}
	
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagram_Constrained/bin/tgg/FacebookToInstagram_Constrained_FWD.msl#//@entities.6
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagram_Constrained/bin/tgg/FacebookToInstagram_Constrained_FWD.msl#//@entities.7
	public IConstraint getConstraint_RequestFriendship_NoOppositeFollowsNAC() {
		var c = (Constraint) spec.getEntities().get(7);
		return NeoConstraintFactory.createNeoConstraint(c, builder);
	}
	
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagram_Constrained/bin/tgg/FacebookToInstagram_Constrained_FWD.msl#//@entities.8
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagram_Constrained/bin/tgg/FacebookToInstagram_Constrained_FWD.msl#//@entities.9
