...
public class API_CompanyToIT_Constrained_GEN {
	private EMSL_Spec spec;
	private NeoCoreBuilder builder;

	/** Use this constructor for default values */
	public API_CompanyToIT_Constrained_GEN(NeoCoreBuilder builder) {
		this(builder, API_Common.PLATFORM_RESOURCE_URI, API_Common.PLATFORM_PLUGIN_URI, API_Common.NEOCORE_URI_INSTALLED);
	}

	/** Use this constructor to configure values for loading EMSL files */
	public API_CompanyToIT_Constrained_GEN(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot, String neocoreURI){
		this((EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/ClassInhHier2DB/CompanyToIT_Constrained/bin/tgg/CompanyToIT_Constrained_GEN.msl", platformResourceURIRoot, platformPluginURIRoot, neocoreURI), builder);
	}

	public API_CompanyToIT_Constrained_GEN(EMSL_Spec spec, NeoCoreBuilder builder) {
		this.spec = spec;
		this.builder = builder;
	}

	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT_Constrained/bin/tgg/CompanyToIT_Constrained_GEN.msl#//@entities.0
	public Collection<NeoRule> getAllRulesForCompanyToIT_Constrained_GEN() {
	...
	public Collection<NeoConstraint> getAllConstraintsForCompanyToIT_Constrained_GEN() {
		Collection<NeoConstraint> constraints = new HashSet<>();
		return constraints;
	}
	
	public Collection<Rule> getAllEMSLRulesForCompanyToIT_Constrained_GEN(){
	...
	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT_Constrained/bin/tgg/CompanyToIT_Constrained_GEN.msl#//@entities.1
	...
	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT_Constrained/bin/tgg/CompanyToIT_Constrained_GEN.msl#//@entities.2
	...
	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT_Constrained/bin/tgg/CompanyToIT_Constrained_GEN.msl#//@entities.3
	...
	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT_Constrained/bin/tgg/CompanyToIT_Constrained_GEN.msl#//@entities.4
	...
	public class AdminToRouterRuleAccess extends NeoRuleCoAccess<AdminToRouterRuleData, AdminToRouterRuleCoData, AdminToRouterRuleMask> {
		...
		public final String _param____srcModelName = "__srcModelName";
		public final String _param__adminName = "adminName";
		public final String _param____trgModelName = "__trgModelName";
	...
	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT_Constrained/bin/tgg/CompanyToIT_Constrained_GEN.msl#//@entities.5
	public IConstraint getConstraint_AdminToRouterRuleNAC() {
		var c = (Constraint) spec.getEntities().get(5);
		return NeoConstraintFactory.createNeoConstraint(c, builder);
	}
	
	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT_Constrained/bin/tgg/CompanyToIT_Constrained_GEN.msl#//@entities.6
	...
	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT_Constrained/bin/tgg/CompanyToIT_Constrained_GEN.msl#//@entities.7
	...
	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT_Constrained/bin/tgg/CompanyToIT_Constrained_GEN.msl#//@entities.8
