...
public class API_FacebookToInstagram_Constrained_BWD_OPT {
	private EMSL_Spec spec;
	private NeoCoreBuilder builder;

	/** Use this constructor for default values */
	public API_FacebookToInstagram_Constrained_BWD_OPT(NeoCoreBuilder builder) {
		this(builder, API_Common.PLATFORM_RESOURCE_URI, API_Common.PLATFORM_PLUGIN_URI, API_Common.NEOCORE_URI_INSTALLED);
	}

	/** Use this constructor to configure values for loading EMSL files */
	public API_FacebookToInstagram_Constrained_BWD_OPT(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot, String neocoreURI){
		this((EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/ClassInhHier2DB/FacebookToInstagram_Constrained/bin/tgg/FacebookToInstagram_Constrained_BWD_OPT.msl", platformResourceURIRoot, platformPluginURIRoot, neocoreURI), builder);
	}

	public API_FacebookToInstagram_Constrained_BWD_OPT(EMSL_Spec spec, NeoCoreBuilder builder) {
		this.spec = spec;
		this.builder = builder;
	}

	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagram_Constrained/bin/tgg/FacebookToInstagram_Constrained_BWD_OPT.msl#//@entities.0
	public Collection<NeoRule> getAllRulesForFacebookToInstagram_Constrained_BWD_OPT() {
	...
	public Collection<NeoConstraint> getAllConstraintsForFacebookToInstagram_Constrained_BWD_OPT() {
		Collection<NeoConstraint> constraints = new HashSet<>();
		return constraints;
	}
	
	public Collection<Rule> getAllEMSLRulesForFacebookToInstagram_Constrained_BWD_OPT(){
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagram_Constrained/bin/tgg/FacebookToInstagram_Constrained_BWD_OPT.msl#//@entities.1
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagram_Constrained/bin/tgg/FacebookToInstagram_Constrained_BWD_OPT.msl#//@entities.2
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagram_Constrained/bin/tgg/FacebookToInstagram_Constrained_BWD_OPT.msl#//@entities.3
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagram_Constrained/bin/tgg/FacebookToInstagram_Constrained_BWD_OPT.msl#//@entities.4
