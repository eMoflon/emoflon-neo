...
public class API_JavaToDoc_GEN {
	...
	public API_JavaToDoc_GEN(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot, String neocoreURI){
		this((EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/ClassInhHier2DB/JavaToDoc/bin/tgg/JavaToDoc_GEN.msl", platformResourceURIRoot, platformPluginURIRoot, neocoreURI), builder);
	}

	public API_JavaToDoc_GEN(EMSL_Spec spec, NeoCoreBuilder builder) {
		this.spec = spec;
		this.builder = builder;
	}

	//:~> platform:/resource/ClassInhHier2DB/JavaToDoc/bin/tgg/JavaToDoc_GEN.msl#//@entities.0
	...
	//:~> platform:/resource/ClassInhHier2DB/JavaToDoc/bin/tgg/JavaToDoc_GEN.msl#//@entities.1
	...
	//:~> platform:/resource/ClassInhHier2DB/JavaToDoc/bin/tgg/JavaToDoc_GEN.msl#//@entities.2
	...
	//:~> platform:/resource/ClassInhHier2DB/JavaToDoc/bin/tgg/JavaToDoc_GEN.msl#//@entities.3
