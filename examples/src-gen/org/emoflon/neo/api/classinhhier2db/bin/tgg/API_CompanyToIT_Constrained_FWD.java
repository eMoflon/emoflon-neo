...
public class API_CompanyToIT_Constrained_FWD {
	private EMSL_Spec spec;
	private NeoCoreBuilder builder;

	/** Use this constructor for default values */
	public API_CompanyToIT_Constrained_FWD(NeoCoreBuilder builder) {
		this(builder, API_Common.PLATFORM_RESOURCE_URI, API_Common.PLATFORM_PLUGIN_URI, API_Common.NEOCORE_URI_INSTALLED);
	}

	/** Use this constructor to configure values for loading EMSL files */
	public API_CompanyToIT_Constrained_FWD(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot, String neocoreURI){
		this((EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/ClassInhHier2DB/CompanyToIT_Constrained/bin/tgg/CompanyToIT_Constrained_FWD.msl", platformResourceURIRoot, platformPluginURIRoot, neocoreURI), builder);
	}

	public API_CompanyToIT_Constrained_FWD(EMSL_Spec spec, NeoCoreBuilder builder) {
		this.spec = spec;
		this.builder = builder;
	}

	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT_Constrained/bin/tgg/CompanyToIT_Constrained_FWD.msl#//@entities.0
	public Collection<NeoRule> getAllRulesForCompanyToIT_Constrained_FWD() {
	...
	public Collection<NeoConstraint> getAllConstraintsForCompanyToIT_Constrained_FWD() {
		Collection<NeoConstraint> constraints = new HashSet<>();
		return constraints;
	}
	
	public Collection<Rule> getAllEMSLRulesForCompanyToIT_Constrained_FWD(){
	...
	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT_Constrained/bin/tgg/CompanyToIT_Constrained_FWD.msl#//@entities.1
	...
	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT_Constrained/bin/tgg/CompanyToIT_Constrained_FWD.msl#//@entities.2
	...
	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT_Constrained/bin/tgg/CompanyToIT_Constrained_FWD.msl#//@entities.3
	...
	//:~> platform:/resource/ClassInhHier2DB/CompanyToIT_Constrained/bin/tgg/CompanyToIT_Constrained_FWD.msl#//@entities.4
