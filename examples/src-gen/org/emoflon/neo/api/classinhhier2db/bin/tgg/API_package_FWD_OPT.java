...
public class API_package_FWD_OPT {
	private EMSL_Spec spec;
	private NeoCoreBuilder builder;

	/** Use this constructor for default values */
	public API_package_FWD_OPT(NeoCoreBuilder builder) {
		this(builder, API_Common.PLATFORM_RESOURCE_URI, API_Common.PLATFORM_PLUGIN_URI, API_Common.NEOCORE_URI_INSTALLED);
	}

	/** Use this constructor to configure values for loading EMSL files */
	public API_package_FWD_OPT(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot, String neocoreURI){
		this((EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/ClassInhHier2DB/JavaKeywords/bin/tgg/package_FWD_OPT.msl", platformResourceURIRoot, platformPluginURIRoot, neocoreURI), builder);
	}

	public API_package_FWD_OPT(EMSL_Spec spec, NeoCoreBuilder builder) {
		this.spec = spec;
		this.builder = builder;
	}

	//:~> platform:/resource/ClassInhHier2DB/JavaKeywords/bin/tgg/package_FWD_OPT.msl#//@entities.0
	public Collection<NeoRule> getAllRulesForPackage_FWD_OPT() {
	...
	public Collection<NeoConstraint> getAllConstraintsForPackage_FWD_OPT() {
		Collection<NeoConstraint> constraints = new HashSet<>();
		return constraints;
	}
	
	public Collection<Rule> getAllEMSLRulesForPackage_FWD_OPT(){
		var rules = new HashSet<Rule>();
		rules.add((Rule) spec.getEntities().get(1));
		return rules;
	}
	
	//:~> platform:/resource/ClassInhHier2DB/JavaKeywords/bin/tgg/package_FWD_OPT.msl#//@entities.1
