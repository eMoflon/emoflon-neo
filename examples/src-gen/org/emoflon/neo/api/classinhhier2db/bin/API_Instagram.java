...
public class API_Instagram {
	...
	public API_Instagram(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot, String neocoreURI){
		this((EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Instagram.msl", platformResourceURIRoot, platformPluginURIRoot, neocoreURI), builder);
	}
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Instagram.msl#//@entities.0
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Instagram.msl#//@entities.1
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Instagram.msl#//@entities.2
	...
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Instagram.msl#//@entities.3
	public IConstraint getConstraint_NoDoubleFollowership() {
		var c = (Constraint) spec.getEntities().get(3);
		return NeoConstraintFactory.createNeoConstraint(c, builder);
	}
	
	//:~> platform:/resource/ClassInhHier2DB/FacebookToInstagramFASE/bin/Instagram.msl#//@entities.4
