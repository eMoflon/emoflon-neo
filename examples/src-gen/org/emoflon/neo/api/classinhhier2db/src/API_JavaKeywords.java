...
public class API_JavaKeywords {
	...
	public API_JavaKeywords(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot, String neocoreURI){
		this((EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/ClassInhHier2DB/JavaKeywords/src/JavaKeywords.msl", platformResourceURIRoot, platformPluginURIRoot, neocoreURI), builder);
	}
	...
	//:~> platform:/resource/ClassInhHier2DB/JavaKeywords/src/JavaKeywords.msl#//@entities.0
	...
	//:~> platform:/resource/ClassInhHier2DB/JavaKeywords/src/JavaKeywords.msl#//@entities.1
	public Model getModel_Interface(){
		return (Model) spec.getEntities().get(1);
	}
	
	//:~> platform:/resource/ClassInhHier2DB/JavaKeywords/src/JavaKeywords.msl#//@entities.2
	...
	//:~> platform:/resource/ClassInhHier2DB/JavaKeywords/src/JavaKeywords.msl#//@entities.3
	...
	//:~> platform:/resource/ClassInhHier2DB/JavaKeywords/src/JavaKeywords.msl#//@entities.4
	public void exportMetamodelsForPackage() throws FlattenerException {
		{
			var api = new org.emoflon.neo.api.classinhhier2db.src.API_JavaKeywords(builder, API_Common.PLATFORM_RESOURCE_URI, API_Common.PLATFORM_PLUGIN_URI, API_Common.NEOCORE_URI_INSTALLED);
	...
	public Collection<TripleRule> getTripleRulesOfPackage(){
		...
		{
			var uri = "platform:/resource/ClassInhHier2DB/JavaKeywords/src/JavaKeywords.msl#//@entities.5";
	...
	//:~> platform:/resource/ClassInhHier2DB/JavaKeywords/src/JavaKeywords.msl#//@entities.5
