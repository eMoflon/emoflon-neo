...
public class API_OCLExpression {
	private EMSL_Spec spec;
	private NeoCoreBuilder builder;

	/** Use this constructor for default values */
	public API_OCLExpression(NeoCoreBuilder builder) {
		this(builder, API_Common.PLATFORM_RESOURCE_URI, API_Common.PLATFORM_PLUGIN_URI, API_Common.NEOCORE_URI_INSTALLED);
	}

	/** Use this constructor to configure values for loading EMSL files */
	public API_OCLExpression(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot, String neocoreURI){
		this((EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/ClassInhHier2DB/TestSuiteGT/resources/expected/model/OCLExpression.msl", platformResourceURIRoot, platformPluginURIRoot, neocoreURI), builder);
	}

	public API_OCLExpression(EMSL_Spec spec, NeoCoreBuilder builder) {
		this.spec = spec;
		this.builder = builder;
	}

	//:~> platform:/resource/ClassInhHier2DB/TestSuiteGT/resources/expected/model/OCLExpression.msl#//@entities.0
	...
	//:~> platform:/resource/ClassInhHier2DB/TestSuiteGT/resources/expected/model/OCLExpression.msl#//@entities.1
	public Model getModel_OCLExpression(){
