...
public class API_CompanyToIT_GEN {
	...
	public API_CompanyToIT_GEN(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot, String neocoreURI){
		this((EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_GEN.msl", platformResourceURIRoot, platformPluginURIRoot, neocoreURI), builder);
	}
	...
	//:~> platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_GEN.msl#//@entities.0
	...
	//:~> platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_GEN.msl#//@entities.1
	...
	//:~> platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_GEN.msl#//@entities.2
	...
	//:~> platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_GEN.msl#//@entities.3
	...
	//:~> platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_GEN.msl#//@entities.4
	...
	//:~> platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_GEN.msl#//@entities.5
	public IConstraint getConstraint_AdminToRouterRuleNAC() {
		var c = (Constraint) spec.getEntities().get(5);
		return NeoConstraintFactory.createNeoConstraint(c, builder);
	}
	
	//:~> platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_GEN.msl#//@entities.6
	...
	//:~> platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_GEN.msl#//@entities.7
	...
	//:~> platform:/resource/CompanyToIT/tgg-gen/tgg/CompanyToIT_GEN.msl#//@entities.8
