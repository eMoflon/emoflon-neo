...
import org.emoflon.neo.api.companytoit_constrained.tgg.API_CompanyToIT_Constrained_BWD;
import org.emoflon.neo.api.companytoit_constrained.tgg.API_CompanyToIT_Constrained_FWD;
...
import org.emoflon.neo.api.companytoit_constrained.run.CompanyToIT_Constrained_FWD_Run;
import org.emoflon.neo.api.companytoit_constrained.run.CompanyToIT_Constrained_BWD_Run;
...
public class Benchmark {
	...
	public static long[] benchmark(long modelSize) throws Throwable {
		...
		var gen = new CompanyToIT_Constrained_GEN_Run(generatedSrcModelName, generatedTrgModelName) {
		...
		var fwd = new CompanyToIT_Constrained_FWD_Run(generatedSrcModelName, derivedTrgModelName) {
			public NeoGenerator createGenerator(NeoCoreBuilder builder) {
				...
				return new NeoGenerator(//
						new API_CompanyToIT_Constrained_FWD(builder).getAllRulesForCompanyToIT_Constrained_FWD(), //
						startUp, //
		...
		var bwd = new CompanyToIT_Constrained_BWD_Run(derivedSrcModelName, generatedTrgModelName) {
			public NeoGenerator createGenerator(NeoCoreBuilder builder) {
				...
				return new NeoGenerator(//
						new API_CompanyToIT_Constrained_BWD(builder).getAllRulesForCompanyToIT_Constrained_BWD(), //
						startUp, //
						new NoMoreMatchesTerminationCondition(), //
						new FixedNoOfMatchesRuleScheduler(1), //
						new AnySingleMatchUpdatePolicy(), //
