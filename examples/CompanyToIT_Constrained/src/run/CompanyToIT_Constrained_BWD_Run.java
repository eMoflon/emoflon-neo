...
public class CompanyToIT_Constrained_BWD_Run {
	private static final Logger logger = Logger.getLogger(CompanyToIT_Constrained_BWD_Run.class);

	public static void main(String[] pArgs) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new CompanyToIT_Constrained_BWD_Run();
		app.runGenerator();
	}

	public void runGenerator() throws FlattenerException, Exception {
		try (var builder = API_Common.createBuilder()) {
			new API_CompanyToIT_Constrained(builder).exportMetamodelsForCompanyToIT_Constrained();
