...
public class CompanyToIT_Constrained_GEN_Run {
	public static final String SRC_MODEL_NAME = "CompanyToIT_Source";
	public static final String TRG_MODEL_NAME = "CompanyToIT_Target";

	private static final Logger logger = Logger.getLogger(CompanyToIT_Constrained_GEN_Run.class);

	public static void main(String[] pArgs) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new CompanyToIT_Constrained_GEN_Run();
		app.runGenerator();
	}
