...
public class CompanyToIT_Constrained_FWD_Run {
	private static final Logger logger = Logger.getLogger(CompanyToIT_Constrained_FWD_Run.class);

	public static void main(String[] pArgs) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new CompanyToIT_Constrained_FWD_Run();
		app.runGenerator();
	}
