...
public class API_CompanyToITTriplesForTesting {
	...
	public API_CompanyToITTriplesForTesting(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot, String neocoreURI){
		spec = (EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/TestSuiteGT/companytoit/CompanyToITTriplesForTesting.msl", platformResourceURIRoot, platformPluginURIRoot, neocoreURI);
		this.builder = builder;
	}

	//:~> platform:/resource/TestSuiteGT/companytoit/CompanyToITTriplesForTesting.msl#//@entities.0
	public Model getModel_ConsistentSrc1(){
		return (Model) spec.getEntities().get(0);
	}
	
	//:~> platform:/resource/TestSuiteGT/companytoit/CompanyToITTriplesForTesting.msl#//@entities.1
	public Model getModel_ConsistentTrg1(){
		return (Model) spec.getEntities().get(1);
	}
	
	//:~> platform:/resource/TestSuiteGT/companytoit/CompanyToITTriplesForTesting.msl#//@entities.2
	...
	//:~> platform:/resource/TestSuiteGT/companytoit/CompanyToITTriplesForTesting.msl#//@entities.3
	public Model getModel_ConsistentTrg2(){
		return (Model) spec.getEntities().get(3);
	}
	
	//:~> platform:/resource/TestSuiteGT/companytoit/CompanyToITTriplesForTesting.msl#//@entities.4
	public Model getModel_ConsistentSrc2(){
		return (Model) spec.getEntities().get(4);
	}
	
	//:~> platform:/resource/TestSuiteGT/companytoit/CompanyToITTriplesForTesting.msl#//@entities.5
	...
	//:~> platform:/resource/TestSuiteGT/companytoit/CompanyToITTriplesForTesting.msl#//@entities.6
	public Model getModel_ConsistentSrc3(){
		return (Model) spec.getEntities().get(6);
	}
	
	//:~> platform:/resource/TestSuiteGT/companytoit/CompanyToITTriplesForTesting.msl#//@entities.7
	public Model getModel_ConsistentTrg3(){
		return (Model) spec.getEntities().get(7);
	}
	
	//:~> platform:/resource/TestSuiteGT/companytoit/CompanyToITTriplesForTesting.msl#//@entities.8
	...
	//:~> platform:/resource/TestSuiteGT/companytoit/CompanyToITTriplesForTesting.msl#//@entities.9
	public Model getModel_ConsistentSrc4(){
		return (Model) spec.getEntities().get(9);
	}
	
	//:~> platform:/resource/TestSuiteGT/companytoit/CompanyToITTriplesForTesting.msl#//@entities.10
	public Model getModel_ConsistentTrg4(){
		return (Model) spec.getEntities().get(10);
	}
	
	//:~> platform:/resource/TestSuiteGT/companytoit/CompanyToITTriplesForTesting.msl#//@entities.11
