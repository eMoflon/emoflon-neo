...
import org.emoflon.neo.api.classinhhier2db.src.tgg.API_CompanyToIT_BWD;
...
public class CompanyToIT_BWD_Run {
	protected static final Logger logger = Logger.getLogger(CompanyToIT_BWD_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new CompanyToIT_BWD_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public CompanyToIT_BWD_Run(String srcModelName, String trgModelName) {
