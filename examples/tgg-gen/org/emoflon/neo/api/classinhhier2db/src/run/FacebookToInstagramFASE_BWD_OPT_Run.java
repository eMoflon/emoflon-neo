...
import org.emoflon.neo.api.classinhhier2db.src.tgg.API_FacebookToInstagramFASE_BWD_OPT;
...
public class FacebookToInstagramFASE_BWD_OPT_Run {
	...
	protected static final Logger logger = Logger.getLogger(FacebookToInstagramFASE_BWD_OPT_Run.class);
	...
	public FacebookToInstagramFASE_BWD_OPT_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		FacebookToInstagramFASE_BWD_OPT_Run.solver = solver;
	}
