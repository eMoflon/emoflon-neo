...
import org.emoflon.neo.api.classinhhier2db.src.tgg.API_package_BWD;
...
public class package_BWD_Run {
	protected static final Logger logger = Logger.getLogger(package_BWD_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new package_BWD_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public package_BWD_Run(String srcModelName, String trgModelName) {
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		return new NeoGenerator(//
				new API_package_BWD(builder).getAllRulesForPackage_BWD(), //
