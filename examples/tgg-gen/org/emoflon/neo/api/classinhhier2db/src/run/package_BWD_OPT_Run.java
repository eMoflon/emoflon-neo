...
import org.emoflon.neo.api.classinhhier2db.src.tgg.API_package_BWD_OPT;
...
public class package_BWD_OPT_Run {
	...
	protected static final Logger logger = Logger.getLogger(package_BWD_OPT_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new package_BWD_OPT_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public package_BWD_OPT_Run(String srcModelName, String trgModelName) {
		this.srcModelName = srcModelName;
		this.trgModelName = trgModelName;
	}
	
	public package_BWD_OPT_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		package_BWD_OPT_Run.solver = solver;
	}
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		...
		var bwd_optAPI = new API_package_BWD_OPT(builder);
		...
		backwardTransformation = new BackwardTransformationOperationalStrategy(//
				...
				builder, //
				genRules, //
				bwd_optAPI.getAllRulesForPackage_BWD_OPT(), //
