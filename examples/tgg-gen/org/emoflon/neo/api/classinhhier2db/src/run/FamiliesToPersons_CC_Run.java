...
import org.emoflon.neo.api.classinhhier2db.src.tgg.API_FamiliesToPersons_CC;
...
public class FamiliesToPersons_CC_Run {
	...
	protected static final Logger logger = Logger.getLogger(FamiliesToPersons_CC_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new FamiliesToPersons_CC_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public FamiliesToPersons_CC_Run(String srcModelName, String trgModelName) {
		this.srcModelName = srcModelName;
		this.trgModelName = trgModelName;
	}
	
	public FamiliesToPersons_CC_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		FamiliesToPersons_CC_Run.solver = solver;
	}
