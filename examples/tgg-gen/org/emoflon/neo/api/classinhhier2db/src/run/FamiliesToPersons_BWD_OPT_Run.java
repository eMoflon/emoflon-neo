...
import org.emoflon.neo.api.classinhhier2db.src.tgg.API_FamiliesToPersons_BWD_OPT;
import org.emoflon.neo.cypher.models.NeoCoreBuilder;
import org.emoflon.neo.engine.modules.NeoGenerator;

import static org.emoflon.neo.api.classinhhier2db.src.run.FamiliesToPersons_GEN_Run.SRC_MODEL_NAME;
import static org.emoflon.neo.api.classinhhier2db.src.run.FamiliesToPersons_GEN_Run.TRG_MODEL_NAME;
		
import java.util.Collection;
import java.util.Collections;
import java.util.List;
import org.emoflon.neo.engine.api.constraints.IConstraint;
import org.emoflon.neo.api.classinhhier2db.src.tgg.API_FamiliesToPersons_GEN;
...
public class FamiliesToPersons_BWD_OPT_Run {
	...
	protected static final Logger logger = Logger.getLogger(FamiliesToPersons_BWD_OPT_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new FamiliesToPersons_BWD_OPT_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public FamiliesToPersons_BWD_OPT_Run(String srcModelName, String trgModelName) {
		this.srcModelName = srcModelName;
		this.trgModelName = trgModelName;
	}
	
	public FamiliesToPersons_BWD_OPT_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		FamiliesToPersons_BWD_OPT_Run.solver = solver;
	}
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		...
		var bwd_optAPI = new API_FamiliesToPersons_BWD_OPT(builder);
		var genRules = genAPI.getAllRulesForFamiliesToPersons_GEN();
		var analyser = new TripleRuleAnalyser(new API_Schema(builder).getTripleRulesOfFamiliesToPersons());
		backwardTransformation = new BackwardTransformationOperationalStrategy(//
				solver, //
				builder, //
				genRules, //
				bwd_optAPI.getAllRulesForFamiliesToPersons_BWD_OPT(), //
