...
public class FacebookToInstagramFASE_GEN_Run {
	public static final String SRC_MODEL_NAME = "FacebookToInstagramFASE_Source";
	public static final String TRG_MODEL_NAME = "FacebookToInstagramFASE_Target";
	protected static final Logger logger = Logger.getLogger(FacebookToInstagramFASE_GEN_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new FacebookToInstagramFASE_GEN_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public FacebookToInstagramFASE_GEN_Run(String srcModelName, String trgModelName) {
