...
import org.emoflon.neo.api.classinhhier2db.src.tgg.API_FacebookToInstagramFASE_MI;
...
public class FacebookToInstagramFASE_MI_Run {
	...
	protected static final Logger logger = Logger.getLogger(FacebookToInstagramFASE_MI_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new FacebookToInstagramFASE_MI_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public FacebookToInstagramFASE_MI_Run(String srcModelName, String trgModelName) {
		this.srcModelName = srcModelName;
		this.trgModelName = trgModelName;
	}
	
	public FacebookToInstagramFASE_MI_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		FacebookToInstagramFASE_MI_Run.solver = solver;
	}
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		...
		var miAPI = new API_FacebookToInstagramFASE_MI(builder);
		...
		modelIntegration = new ModelIntegrationOperationalStrategy(//
				...
				builder, //
				genRules, //
				miAPI.getAllRulesForFacebookToInstagramFASE_MI(), //
