...
import org.emoflon.neo.api.classinhhier2db.src.tgg.API_FamiliesToPersons_MI;
...
public class FamiliesToPersons_MI_Run {
	...
	protected static final Logger logger = Logger.getLogger(FamiliesToPersons_MI_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new FamiliesToPersons_MI_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public FamiliesToPersons_MI_Run(String srcModelName, String trgModelName) {
		this.srcModelName = srcModelName;
		this.trgModelName = trgModelName;
	}
	
	public FamiliesToPersons_MI_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		FamiliesToPersons_MI_Run.solver = solver;
	}
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		...
		var miAPI = new API_FamiliesToPersons_MI(builder);
		...
		modelIntegration = new ModelIntegrationOperationalStrategy(//
				...
				builder, //
				genRules, //
				miAPI.getAllRulesForFamiliesToPersons_MI(), //
