...
import org.emoflon.neo.api.classinhhier2db.src.tgg.API_CompanyToIT_Constrained_CC;
...
public class CompanyToIT_Constrained_CC_Run {
	...
	protected static final Logger logger = Logger.getLogger(CompanyToIT_Constrained_CC_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new CompanyToIT_Constrained_CC_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public CompanyToIT_Constrained_CC_Run(String srcModelName, String trgModelName) {
		this.srcModelName = srcModelName;
		this.trgModelName = trgModelName;
	}
	
	public CompanyToIT_Constrained_CC_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		CompanyToIT_Constrained_CC_Run.solver = solver;
	}
