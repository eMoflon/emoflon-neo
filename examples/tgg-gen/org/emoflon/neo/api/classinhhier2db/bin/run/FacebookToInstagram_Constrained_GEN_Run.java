...
public class FacebookToInstagram_Constrained_GEN_Run {
	public static final String SRC_MODEL_NAME = "FacebookToInstagram_Constrained_Source";
	public static final String TRG_MODEL_NAME = "FacebookToInstagram_Constrained_Target";
	protected static final Logger logger = Logger.getLogger(FacebookToInstagram_Constrained_GEN_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new FacebookToInstagram_Constrained_GEN_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public FacebookToInstagram_Constrained_GEN_Run(String srcModelName, String trgModelName) {
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		var allRules = new API_FacebookToInstagram_Constrained_GEN(builder).getAllRulesForFacebookToInstagram_Constrained_GEN();
