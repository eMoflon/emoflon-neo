...
import org.emoflon.neo.api.classinhhier2db.bin.tgg.API_JavaToDoc_BWD;
...
public class JavaToDoc_BWD_Run {
	protected static final Logger logger = Logger.getLogger(JavaToDoc_BWD_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new JavaToDoc_BWD_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public JavaToDoc_BWD_Run(String srcModelName, String trgModelName) {
