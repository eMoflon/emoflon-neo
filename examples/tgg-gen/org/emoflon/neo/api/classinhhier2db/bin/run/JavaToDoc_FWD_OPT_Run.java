...
import org.emoflon.neo.api.classinhhier2db.bin.tgg.API_JavaToDoc_FWD_OPT;
...
public class JavaToDoc_FWD_OPT_Run {
	...
	protected static final Logger logger = Logger.getLogger(JavaToDoc_FWD_OPT_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new JavaToDoc_FWD_OPT_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public JavaToDoc_FWD_OPT_Run(String srcModelName, String trgModelName) {
		this.srcModelName = srcModelName;
		this.trgModelName = trgModelName;
	}
	
	public JavaToDoc_FWD_OPT_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		JavaToDoc_FWD_OPT_Run.solver = solver;
	}
