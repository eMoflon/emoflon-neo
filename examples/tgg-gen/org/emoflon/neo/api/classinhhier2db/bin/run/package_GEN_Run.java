...
public class package_GEN_Run {
	public static final String SRC_MODEL_NAME = "package_Source";
	public static final String TRG_MODEL_NAME = "package_Target";
	protected static final Logger logger = Logger.getLogger(package_GEN_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new package_GEN_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public package_GEN_Run(String srcModelName, String trgModelName) {
	...
	public void run() throws Exception {
		try (var builder = API_Common.createBuilder()) {
			new API_JavaKeywords(builder).exportMetamodelsForPackage();
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		var allRules = new API_package_GEN(builder).getAllRulesForPackage_GEN();
