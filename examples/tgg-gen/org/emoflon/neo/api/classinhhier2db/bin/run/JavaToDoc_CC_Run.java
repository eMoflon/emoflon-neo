...
import org.emoflon.neo.api.classinhhier2db.bin.tgg.API_JavaToDoc_CC;
...
public class JavaToDoc_CC_Run {
	...
	protected static final Logger logger = Logger.getLogger(JavaToDoc_CC_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new JavaToDoc_CC_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public JavaToDoc_CC_Run(String srcModelName, String trgModelName) {
		this.srcModelName = srcModelName;
		this.trgModelName = trgModelName;
	}
	
	public JavaToDoc_CC_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		JavaToDoc_CC_Run.solver = solver;
	}
