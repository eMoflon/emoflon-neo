...
public class FacebookToInstagramGrammar_GEN_Run {
	public static final String SRC_MODEL_NAME = "FacebookToInstagramGrammar_Source";
	public static final String TRG_MODEL_NAME = "FacebookToInstagramGrammar_Target";
	protected static final Logger logger = Logger.getLogger(FacebookToInstagramGrammar_GEN_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new FacebookToInstagramGrammar_GEN_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public FacebookToInstagramGrammar_GEN_Run(String srcModelName, String trgModelName) {
