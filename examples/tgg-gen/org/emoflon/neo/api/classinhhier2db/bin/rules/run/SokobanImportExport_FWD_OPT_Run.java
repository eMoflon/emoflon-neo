 ...
 */
package org.emoflon.neo.api.classinhhier2db.bin.rules.run;

import org.apache.log4j.Level;
import org.apache.log4j.Logger;
import org.emoflon.neo.api.classinhhier2db.API_Common;
import org.emoflon.neo.api.classinhhier2db.bin.rules.API_SokobanTGGs;
import org.emoflon.neo.api.classinhhier2db.bin.rules.tgg.API_SokobanImportExport_FWD_OPT;
import org.emoflon.neo.cypher.models.NeoCoreBuilder;
import org.emoflon.neo.engine.modules.NeoGenerator;

import static org.emoflon.neo.api.classinhhier2db.bin.rules.run.SokobanImportExport_GEN_Run.SRC_MODEL_NAME;
import static org.emoflon.neo.api.classinhhier2db.bin.rules.run.SokobanImportExport_GEN_Run.TRG_MODEL_NAME;
		
import java.util.Collection;
import java.util.Collections;
import java.util.List;
import org.emoflon.neo.engine.api.constraints.IConstraint;
import org.emoflon.neo.api.classinhhier2db.bin.rules.tgg.API_SokobanImportExport_GEN;
...
public class SokobanImportExport_FWD_OPT_Run {
	...
	protected static final Logger logger = Logger.getLogger(SokobanImportExport_FWD_OPT_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new SokobanImportExport_FWD_OPT_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public SokobanImportExport_FWD_OPT_Run(String srcModelName, String trgModelName) {
		this.srcModelName = srcModelName;
		this.trgModelName = trgModelName;
	}
	
	public SokobanImportExport_FWD_OPT_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		SokobanImportExport_FWD_OPT_Run.solver = solver;
	}
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		...
		var fwd_optAPI = new API_SokobanImportExport_FWD_OPT(builder);
		...
		forwardTransformation = new ForwardTransformationOperationalStrategy(//
				...
				builder, //
				genRules, //
				fwd_optAPI.getAllRulesForSokobanImportExport_FWD_OPT(), //
