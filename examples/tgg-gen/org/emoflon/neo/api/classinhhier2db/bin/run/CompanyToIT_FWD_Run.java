...
import org.emoflon.neo.api.classinhhier2db.bin.tgg.API_CompanyToIT_FWD;
...
public class CompanyToIT_FWD_Run {
	protected static final Logger logger = Logger.getLogger(CompanyToIT_FWD_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new CompanyToIT_FWD_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public CompanyToIT_FWD_Run(String srcModelName, String trgModelName) {
