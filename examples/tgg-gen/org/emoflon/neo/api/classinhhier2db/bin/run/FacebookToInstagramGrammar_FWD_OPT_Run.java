...
import org.emoflon.neo.api.classinhhier2db.bin.tgg.API_FacebookToInstagramGrammar_FWD_OPT;
import org.emoflon.neo.cypher.models.NeoCoreBuilder;
import org.emoflon.neo.engine.modules.NeoGenerator;

import static org.emoflon.neo.api.classinhhier2db.bin.run.FacebookToInstagramGrammar_GEN_Run.SRC_MODEL_NAME;
import static org.emoflon.neo.api.classinhhier2db.bin.run.FacebookToInstagramGrammar_GEN_Run.TRG_MODEL_NAME;
		
import java.util.Collection;
import java.util.Collections;
import java.util.List;
import org.emoflon.neo.engine.api.constraints.IConstraint;
import org.emoflon.neo.api.classinhhier2db.bin.tgg.API_FacebookToInstagramGrammar_GEN;
...
public class FacebookToInstagramGrammar_FWD_OPT_Run {
	...
	protected static final Logger logger = Logger.getLogger(FacebookToInstagramGrammar_FWD_OPT_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new FacebookToInstagramGrammar_FWD_OPT_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public FacebookToInstagramGrammar_FWD_OPT_Run(String srcModelName, String trgModelName) {
		this.srcModelName = srcModelName;
		this.trgModelName = trgModelName;
	}
	
	public FacebookToInstagramGrammar_FWD_OPT_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		FacebookToInstagramGrammar_FWD_OPT_Run.solver = solver;
	}
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		...
		var fwd_optAPI = new API_FacebookToInstagramGrammar_FWD_OPT(builder);
		...
		forwardTransformation = new ForwardTransformationOperationalStrategy(//
				...
				builder, //
				genRules, //
				fwd_optAPI.getAllRulesForFacebookToInstagramGrammar_FWD_OPT(), //
