...
import org.emoflon.neo.api.classinhhier2db.bin.rules.tgg.API_SokobanImportExport_MI;
...
public class SokobanImportExport_MI_Run {
	...
	protected static final Logger logger = Logger.getLogger(SokobanImportExport_MI_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new SokobanImportExport_MI_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public SokobanImportExport_MI_Run(String srcModelName, String trgModelName) {
		this.srcModelName = srcModelName;
		this.trgModelName = trgModelName;
	}
	
	public SokobanImportExport_MI_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		SokobanImportExport_MI_Run.solver = solver;
	}
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		...
		var miAPI = new API_SokobanImportExport_MI(builder);
		...
		modelIntegration = new ModelIntegrationOperationalStrategy(//
				...
				builder, //
				genRules, //
				miAPI.getAllRulesForSokobanImportExport_MI(), //
