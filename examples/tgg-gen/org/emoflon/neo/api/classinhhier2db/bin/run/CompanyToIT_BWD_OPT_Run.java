...
import org.emoflon.neo.api.classinhhier2db.bin.API_CompanyToIT;
import org.emoflon.neo.api.classinhhier2db.bin.tgg.API_CompanyToIT_BWD_OPT;
import org.emoflon.neo.cypher.models.NeoCoreBuilder;
import org.emoflon.neo.engine.modules.NeoGenerator;

import static org.emoflon.neo.api.classinhhier2db.bin.run.CompanyToIT_GEN_Run.SRC_MODEL_NAME;
import static org.emoflon.neo.api.classinhhier2db.bin.run.CompanyToIT_GEN_Run.TRG_MODEL_NAME;
		
import java.util.Collection;
import java.util.Collections;
import java.util.List;
import org.emoflon.neo.engine.api.constraints.IConstraint;
import org.emoflon.neo.api.classinhhier2db.bin.tgg.API_CompanyToIT_GEN;
...
public class CompanyToIT_BWD_OPT_Run {
	...
	protected static final Logger logger = Logger.getLogger(CompanyToIT_BWD_OPT_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new CompanyToIT_BWD_OPT_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public CompanyToIT_BWD_OPT_Run(String srcModelName, String trgModelName) {
		this.srcModelName = srcModelName;
		this.trgModelName = trgModelName;
	}
	
	public CompanyToIT_BWD_OPT_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		CompanyToIT_BWD_OPT_Run.solver = solver;
	}
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		...
		var bwd_optAPI = new API_CompanyToIT_BWD_OPT(builder);
		...
		backwardTransformation = new BackwardTransformationOperationalStrategy(//
				...
				builder, //
				genRules, //
				bwd_optAPI.getAllRulesForCompanyToIT_BWD_OPT(), //
