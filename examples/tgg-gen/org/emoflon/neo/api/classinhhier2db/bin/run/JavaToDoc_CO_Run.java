...
import org.emoflon.neo.api.classinhhier2db.bin.tgg.API_JavaToDoc_CO;
...
public class JavaToDoc_CO_Run {
	...
	protected static final Logger logger = Logger.getLogger(JavaToDoc_CO_Run.class);
	...
	public JavaToDoc_CO_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		JavaToDoc_CO_Run.solver = solver;
	}
