...
import org.emoflon.neo.api.classinhhier2db.bin.tgg.API_FacebookToInstagram_Constrained_MI;
...
public class FacebookToInstagram_Constrained_MI_Run {
	...
	protected static final Logger logger = Logger.getLogger(FacebookToInstagram_Constrained_MI_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new FacebookToInstagram_Constrained_MI_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public FacebookToInstagram_Constrained_MI_Run(String srcModelName, String trgModelName) {
		this.srcModelName = srcModelName;
		this.trgModelName = trgModelName;
	}
	
	public FacebookToInstagram_Constrained_MI_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		FacebookToInstagram_Constrained_MI_Run.solver = solver;
	}
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		...
		var miAPI = new API_FacebookToInstagram_Constrained_MI(builder);
		...
		modelIntegration = new ModelIntegrationOperationalStrategy(//
				...
				builder, //
				genRules, //
				miAPI.getAllRulesForFacebookToInstagram_Constrained_MI(), //
