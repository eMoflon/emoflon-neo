...
import org.emoflon.neo.api.classinhhier2db.bin.tgg.API_package_CC;
...
public class package_CC_Run {
	...
	protected static final Logger logger = Logger.getLogger(package_CC_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new package_CC_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public package_CC_Run(String srcModelName, String trgModelName) {
		this.srcModelName = srcModelName;
		this.trgModelName = trgModelName;
	}
	
	public package_CC_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		package_CC_Run.solver = solver;
	}
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		...
		var ccAPI = new API_package_CC(builder);
		...
		corrCreation = new CorrCreationOperationalStrategy(//
				...
				builder, //
				genRules, //
				ccAPI.getAllRulesForPackage_CC(), //
