...
import org.emoflon.neo.api.classinhhier2db.bin.tgg.API_FacebookToInstagramGrammar_FWD;
...
public class FacebookToInstagramGrammar_FWD_Run {
	protected static final Logger logger = Logger.getLogger(FacebookToInstagramGrammar_FWD_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new FacebookToInstagramGrammar_FWD_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public FacebookToInstagramGrammar_FWD_Run(String srcModelName, String trgModelName) {
	...
	public void run() throws Exception {
		try (var builder = API_Common.createBuilder()) {
			new API_Transformations(builder).exportMetamodelsForFacebookToInstagramGrammar();
