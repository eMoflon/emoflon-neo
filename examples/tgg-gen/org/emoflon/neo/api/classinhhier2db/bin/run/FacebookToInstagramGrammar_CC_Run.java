...
import org.emoflon.neo.api.classinhhier2db.bin.tgg.API_FacebookToInstagramGrammar_CC;
...
public class FacebookToInstagramGrammar_CC_Run {
	...
	protected static final Logger logger = Logger.getLogger(FacebookToInstagramGrammar_CC_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new FacebookToInstagramGrammar_CC_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public FacebookToInstagramGrammar_CC_Run(String srcModelName, String trgModelName) {
		this.srcModelName = srcModelName;
		this.trgModelName = trgModelName;
	}
	
	public FacebookToInstagramGrammar_CC_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		FacebookToInstagramGrammar_CC_Run.solver = solver;
	}
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		...
		var ccAPI = new API_FacebookToInstagramGrammar_CC(builder);
		...
		corrCreation = new CorrCreationOperationalStrategy(//
				...
				builder, //
				genRules, //
				ccAPI.getAllRulesForFacebookToInstagramGrammar_CC(), //
