...
import org.emoflon.neo.api.classinhhier2db.bin.tgg.API_FacebookToInstagramGrammar_MI;
...
public class FacebookToInstagramGrammar_MI_Run {
	...
	protected static final Logger logger = Logger.getLogger(FacebookToInstagramGrammar_MI_Run.class);
	protected String srcModelName;
	protected String trgModelName;
	
	public static void main(String[] args) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new FacebookToInstagramGrammar_MI_Run(SRC_MODEL_NAME, TRG_MODEL_NAME);
		app.run();
	}
	
	public FacebookToInstagramGrammar_MI_Run(String srcModelName, String trgModelName) {
		this.srcModelName = srcModelName;
		this.trgModelName = trgModelName;
	}
	
	public FacebookToInstagramGrammar_MI_Run(String srcModelName, String trgModelName, SupportedILPSolver solver) {
		this(srcModelName, trgModelName);
		FacebookToInstagramGrammar_MI_Run.solver = solver;
	}
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		...
		var miAPI = new API_FacebookToInstagramGrammar_MI(builder);
		...
		modelIntegration = new ModelIntegrationOperationalStrategy(//
				...
				builder, //
				genRules, //
				miAPI.getAllRulesForFacebookToInstagramGrammar_MI(), //
