...
import org.emoflon.neo.api.javatodoc.tgg.API_JavaToDoc_BWD;
...
public class JavaToDoc_BWD_Run {
	private static final Logger logger = Logger.getLogger(JavaToDoc_BWD_Run.class);

	public static void main(String[] pArgs) throws Exception {
		Logger.getRootLogger().setLevel(Level.INFO);
		var app = new JavaToDoc_BWD_Run();
		app.runGenerator();
	}
