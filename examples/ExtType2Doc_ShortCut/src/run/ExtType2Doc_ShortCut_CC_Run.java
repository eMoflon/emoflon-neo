...
import org.emoflon.neo.api.exttype2doc_shortcut.tgg.API_ExtType2Doc_ShortCut_CC;
...
public class ExtType2Doc_ShortCut_CC_Run {
	private static final Logger logger = Logger.getLogger(ExtType2Doc_ShortCut_CC_Run.class);
	...
	public static void main(String[] pArgs) throws Exception {
		...
		var app = new ExtType2Doc_ShortCut_CC_Run();
		app.run();
	}
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		...
		var ccAPI = new API_ExtType2Doc_ShortCut_CC(builder);
		...
		corrCreation = new CorrCreationOperationalStrategy(//
				...
				builder, //
				genRules, //
				ccAPI.getAllRulesForExtType2Doc_ShortCut_CC(), //
