...
import org.emoflon.neo.api.exttype2doc_shortcut.tgg.API_ExtType2Doc_ShortCut_FWD_OPT;
...
public class ExtType2Doc_ShortCut_FWD_OPT_Run {
	private static final Logger logger = Logger.getLogger(ExtType2Doc_ShortCut_FWD_OPT_Run.class);
	...
	public static void main(String[] pArgs) throws Exception {
		...
		var app = new ExtType2Doc_ShortCut_FWD_OPT_Run();
		app.run();
	}
	...
	public NeoGenerator createGenerator(NeoCoreBuilder builder) {
		...
		var fwd_optAPI = new API_ExtType2Doc_ShortCut_FWD_OPT(builder);
		...
		forwardTransformation = new CorrCreationOperationalStrategy(//
				...
				builder, //
				genRules, //
				fwd_optAPI.getAllRulesForExtType2Doc_ShortCut_FWD_OPT(), //
